    ...
    <div className="p-6  mx-auto space-y-6">
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>
              {editingId ? "Update Applicant" : "Create Applicant"}
            </DialogTitle>
          </DialogHeader>
      ...
      <h2 className="text-xl font-semibold mt-8">All Applicants</h2>
          ...
          <tbody className="divide-y divide-gray-200">
            {data.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2">{item.governmentId}</td>
                <td className="px-4 py-2">{item.status}</td>
                <td className="px-4 py-2">{item.passType}</td>
                ...
                <td className="px-4 py-2">
                  {item.validTo
                    ? new Date(item.validTo).toLocaleString()
                    : "N/A"}
                </td>
